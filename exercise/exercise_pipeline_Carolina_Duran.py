...
def collect_image_paths(data_dir):
    ...
    crawler = futil.FileSystemDataCrawler('../data/exercise/', image_keys, MyFilePathGenerator(), dir_filter, '.nii.gz')  # todo: modify here
...
def register_images(image_dict, atlas_img):
    ...
    registered_gt = sitk.Resample(gt_img, atlas_img, registration.transform, sitk.sitkNearestNeighbor, 0.0, gt_img.GetPixelIDValue())  # todo: modify here
